...
def create_data_loaders(args):
    ...
    testdir = os.path.join('data', args.data, 'val')
    train_loader = None
    val_loader = None
...
def test(test_loader, model, save_path="./result/"):
    ...
    for i, (input, target, name) in enumerate(test_loader):
        ...
        rgb, depth, target, pred = utils.strentch_img(rgb, depth, target, pred)
